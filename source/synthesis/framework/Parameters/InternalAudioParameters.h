//#pragma once
//#include <string>
//#include <juce_core/juce_core.h> //including for juce::CriticalSection don't think i actually need it but will look into
...
//{
//public:
//    InternalParameter() noexcept = default;
//
//    /** Destructor. */
//    virtual ~InternalParameter();
//
...
//    */
//    virtual std::string getName (int maximumStringLength) const = 0;
//
...
//        of value.
//    */
//    virtual std::string getText (float normalisedValue, int /*maximumStringLength*/) const;
//
//    /** Should parse a string and return the appropriate value for it. */
//    virtual float getValueForText (const std::string& text) const = 0;
//
...
//    */
//    virtual std::string getCurrentValueAsText() const;
//
...
//@tags{Audio}
//    */
//class InternalParameterWithIDAttributes
//{
//    using This = InternalParameterWithIDAttributes;
//
//        public :
//
//        /** An optional label for the parameter's value */
//        [[nodiscard]] auto
//        withLabel (std::string x) const
//    {
//        return withMember (*this, &This::label, std::move (x));
//    }
//
//    /** An optional label for the parameter's value */
...
//                                                                     @tags{Audio}
//                                                                     */
//class InternalParameterWithID : public InternalParameter
//{
//public:
...
//        @code
//        MyParameterType (String paramID, std::string name, std::string label, bool automatable)
...
//    */
//    InternalParameterWithID (const std::string& parameterID,
...
//
//
//    std::string getParameterID() const override { return paramID; }
//
//private:
...
//class InternalRangedParameterAttributes
//{
//    using This = InternalRangedParameterAttributes;
//
//public:
//
//
//    using StringFromValue = std::function<std::string (Value, int)>;
//    using ValueFromString = std::function<Value (const std::string&)>;
//
...
//    [[nodiscard]] auto withLabel (std::string x) const { return withMember (asDerived(), &Derived::attributes, attributes.withLabel (std::move (x))); }
//
//    /** An optional lambda function that converts a non-normalised value to a string with a maximum length. This may be used by hosts to display the parameter's value. */
...
//    [[nodiscard]] const auto& getInternalParameterWithIDAttributes() const { return attributes; }
//
//private:
//    auto& asDerived() const { return *static_cast<const Derived*> (this); }
//
//   InternalParameterWithIDAttributes attributes;
...
//    class InternalRangedParameter : public InternalParameterWithID
//{
//public:
//    using InternalParameterWithID::InternalParameterWithID;
//
//    /** Returns the range of values that the parameter can take. */
//    virtual const RangeType& getNormalisableRange() const = 0;
//
...
//
//
//class InternalNormalisableRangedParameter : public InternalRangedParameter<juce::NormalisableRange<float>>
//{
//public:
//
//    InternalNormalisableRangedParameter(std::string id, std::string name, const InternalParameterWithIDAttributes& attributes = {})
//    :
//    InternalRangedParameter<juce::NormalisableRange<float>>(id, name, attributes)
//    {}
//
//
//};
