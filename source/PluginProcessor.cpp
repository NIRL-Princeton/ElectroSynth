...
void PluginProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages) {
    ...
    // This is the place where you'd normally do the guts of your plugin's audio processing... Make sure to reset
    // the state if your inner loop is processing the samples and the outer loop is handling the channels.
